...
void ibValueSystemFunction_BindNames(ibValue::ibMemberTable& helper, const ibValue* /*ctx*/)
{
	...
	// SAME method number as its English target, so CallAsFunc / the en* dispatch is untouched.
	...
	helper.AliasMethod(wxString::FromUTF8("\xD0\xB1\xD1\x83\xD0\xBB\xD0\xB5\xD0\xB2\xD0\xBE"), wxT("Boolean"));  // булево
	helper.AliasMethod(wxString::FromUTF8("\xD1\x82\xD0\xB8\xD0\xBF"), wxT("Type"));  // тип
	helper.AliasMethod(wxString::FromUTF8("\xD1\x82\xD0\xB8\xD0\xBF\xD0\xB7\xD0\xBD\xD1\x87"), wxT("TypeOf"));  // типзнч
	helper.AliasMethod(wxString::FromUTF8("\xD1\x81\xD1\x82\xD1\x80\xD0\xB4\xD0\xBB\xD0\xB8\xD0\xBD\xD0\xB0"), wxT("StrLen"));  // стрдлина
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBF\xD1\x83\xD1\x81\xD1\x82\xD0\xB0\xD1\x8F\xD1\x81\xD1\x82\xD1\x80\xD0\xBE\xD0\xBA\xD0\xB0"), wxT("IsBlankString"));  // пустаястрока
	helper.AliasMethod(wxString::FromUTF8("\xD1\x81\xD0\xBE\xD0\xBA\xD1\x80\xD0\xBB\xD0\xBF"), wxT("TrimAll"));  // сокрлп
	helper.AliasMethod(wxString::FromUTF8("\xD1\x81\xD0\xBE\xD0\xBA\xD1\x80\xD0\xBB"), wxT("TrimL"));  // сокрл
	helper.AliasMethod(wxString::FromUTF8("\xD1\x81\xD0\xBE\xD0\xBA\xD1\x80\xD0\xBF"), wxT("TrimR"));  // сокрп
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBB\xD0\xB5\xD0\xB2"), wxT("Left"));  // лев
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBF\xD1\x80\xD0\xB0\xD0\xB2"), wxT("Right"));  // прав
	helper.AliasMethod(wxString::FromUTF8("\xD1\x81\xD1\x80\xD0\xB5\xD0\xB4"), wxT("Mid"));  // сред
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBD\xD0\xB0\xD0\xB9\xD1\x82\xD0\xB8"), wxT("Find"));  // найти
	helper.AliasMethod(wxString::FromUTF8("\xD1\x81\xD1\x82\xD1\x80\xD0\xB7\xD0\xB0\xD0\xBC\xD0\xB5\xD0\xBD\xD0\xB8\xD1\x82\xD1\x8C"), wxT("StrReplace"));  // стрзаменить
	helper.AliasMethod(wxString::FromUTF8("\xD1\x81\xD1\x82\xD1\x80\xD1\x87\xD0\xB8\xD1\x81\xD0\xBB\xD0\xBE\xD1\x81\xD1\x82\xD1\x80\xD0\xBE\xD0\xBA"), wxT("StrLineCount"));  // стрчислострок
	helper.AliasMethod(wxString::FromUTF8("\xD1\x81\xD1\x82\xD1\x80\xD0\xBF\xD0\xBE\xD0\xBB\xD1\x83\xD1\x87\xD0\xB8\xD1\x82\xD1\x8C\xD1\x81\xD1\x82\xD1\x80\xD0\xBE\xD0\xBA\xD1\x83"), wxT("StrGetLine"));  // стрполучитьстроку
	helper.AliasMethod(wxString::FromUTF8("\xD0\xB2\xD1\x80\xD0\xB5\xD0\xB3"), wxT("Upper"));  // врег
	...
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBC\xD0\xB8\xD0\xBD"), wxT("Min"));  // мин
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBB\xD0\xBE\xD0\xB3\x31\x30"), wxT("Log10"));  // лог10
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBB\xD0\xBD"), wxT("Ln"));  // лн
	helper.AliasMethod(wxString::FromUTF8("\xD1\x82\xD0\xB5\xD0\xBA\xD1\x83\xD1\x89\xD0\xB0\xD1\x8F\xD0\xB4\xD0\xB0\xD1\x82\xD0\xB0"), wxT("CurrentDate"));  // текущаядата
	helper.AliasMethod(wxString::FromUTF8("\xD1\x80\xD0\xB0\xD0\xB1\xD0\xBE\xD1\x87\xD0\xB0\xD1\x8F\xD0\xB4\xD0\xB0\xD1\x82\xD0\xB0"), wxT("WorkingDate"));  // рабочаядата
	helper.AliasMethod(wxString::FromUTF8("\xD0\xB4\xD0\xBE\xD0\xB1\xD0\xB0\xD0\xB2\xD0\xB8\xD1\x82\xD1\x8C\xD0\xBC\xD0\xB5\xD1\x81\xD1\x8F\xD1\x86"), wxT("AddMonth"));  // добавитьмесяц
	helper.AliasMethod(wxString::FromUTF8("\xD0\xB3\xD0\xBE\xD0\xB4"), wxT("GetYear"));  // год
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBC\xD0\xB5\xD1\x81\xD1\x8F\xD1\x86"), wxT("GetMonth"));  // месяц
	helper.AliasMethod(wxString::FromUTF8("\xD0\xB4\xD0\xB5\xD0\xBD\xD1\x8C"), wxT("GetDay"));  // день
	helper.AliasMethod(wxString::FromUTF8("\xD1\x87\xD0\xB0\xD1\x81"), wxT("GetHour"));  // час
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBC\xD0\xB8\xD0\xBD\xD1\x83\xD1\x82\xD0\xB0"), wxT("GetMinute"));  // минута
	helper.AliasMethod(wxString::FromUTF8("\xD1\x81\xD0\xB5\xD0\xBA\xD1\x83\xD0\xBD\xD0\xB4\xD0\xB0"), wxT("GetSecond"));  // секунда
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBD\xD0\xB5\xD0\xB4\xD0\xB5\xD0\xBB\xD1\x8F\xD0\xB3\xD0\xBE\xD0\xB4\xD0\xB0"), wxT("GetWeekOfYear"));  // неделягода
	helper.AliasMethod(wxString::FromUTF8("\xD0\xB4\xD0\xB5\xD0\xBD\xD1\x8C\xD0\xB3\xD0\xBE\xD0\xB4\xD0\xB0"), wxT("GetDayOfYear"));  // деньгода
	helper.AliasMethod(wxString::FromUTF8("\xD0\xB4\xD0\xB5\xD0\xBD\xD1\x8C\xD0\xBD\xD0\xB5\xD0\xB4\xD0\xB5\xD0\xBB\xD0\xB8"), wxT("GetDayOfWeek"));  // деньнедели
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBD\xD0\xB0\xD1\x87\xD0\xB0\xD0\xBB\xD0\xBE\xD0\xBC\xD0\xB5\xD1\x81\xD1\x8F\xD1\x86\xD0\xB0"), wxT("BegOfMonth"));  // началомесяца
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBA\xD0\xBE\xD0\xBD\xD0\xB5\xD1\x86\xD0\xBC\xD0\xB5\xD1\x81\xD1\x8F\xD1\x86\xD0\xB0"), wxT("EndOfMonth"));  // конецмесяца
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBD\xD0\xB0\xD1\x87\xD0\xB0\xD0\xBB\xD0\xBE\xD0\xBA\xD0\xB2\xD0\xB0\xD1\x80\xD1\x82\xD0\xB0\xD0\xBB\xD0\xB0"), wxT("BegOfQuart"));  // началоквартала
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBA\xD0\xBE\xD0\xBD\xD0\xB5\xD1\x86\xD0\xBA\xD0\xB2\xD0\xB0\xD1\x80\xD1\x82\xD0\xB0\xD0\xBB\xD0\xB0"), wxT("EndOfQuart"));  // конецквартала
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBD\xD0\xB0\xD1\x87\xD0\xB0\xD0\xBB\xD0\xBE\xD0\xB3\xD0\xBE\xD0\xB4\xD0\xB0"), wxT("BegOfYear"));  // началогода
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBA\xD0\xBE\xD0\xBD\xD0\xB5\xD1\x86\xD0\xB3\xD0\xBE\xD0\xB4\xD0\xB0"), wxT("EndOfYear"));  // конецгода
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBD\xD0\xB0\xD1\x87\xD0\xB0\xD0\xBB\xD0\xBE\xD0\xBD\xD0\xB5\xD0\xB4\xD0\xB5\xD0\xBB\xD0\xB8"), wxT("BegOfWeek"));  // началонедели
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBA\xD0\xBE\xD0\xBD\xD0\xB5\xD1\x86\xD0\xBD\xD0\xB5\xD0\xB4\xD0\xB5\xD0\xBB\xD0\xB8"), wxT("EndOfWeek"));  // конецнедели
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBD\xD0\xB0\xD1\x87\xD0\xB0\xD0\xBB\xD0\xBE\xD0\xB4\xD0\xBD\xD1\x8F"), wxT("BegOfDay"));  // началодня
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBA\xD0\xBE\xD0\xBD\xD0\xB5\xD1\x86\xD0\xB4\xD0\xBD\xD1\x8F"), wxT("EndOfDay"));  // конецдня
	helper.AliasMethod(wxString::FromUTF8("\xD1\x84\xD0\xBE\xD1\x80\xD0\xBC\xD0\xB0\xD1\x82"), wxT("Format"));  // формат
	helper.AliasMethod(wxString::FromUTF8("\xD0\xB2\xD1\x8B\xD1\x87\xD0\xB8\xD1\x81\xD0\xBB\xD0\xB8\xD1\x82\xD1\x8C"), wxT("Evaluate"));  // вычислить
	helper.AliasMethod(wxString::FromUTF8("\xD0\xB2\xD1\x8B\xD0\xBF\xD0\xBE\xD0\xBB\xD0\xBD\xD0\xB8\xD1\x82\xD1\x8C"), wxT("Execute"));  // выполнить
	...
	helper.AliasMethod(wxString::FromUTF8("\xD0\xBE\xD1\x87\xD0\xB8\xD1\x81\xD1\x82\xD0\xB8\xD1\x82\xD1\x8C\xD1\x81\xD0\xBE\xD0\xBE\xD0\xB1\xD1\x89\xD0\xB5\xD0\xBD\xD0\xB8\xD1\x8F"), wxT("ClearMessages"));  // очиститьсообщения
	helper.AliasMethod(wxString::FromUTF8("\xD0\xB8\xD0\xBC\xD1\x8F\xD0\xBA\xD0\xBE\xD0\xBC\xD0\xBF\xD1\x8C\xD1\x8E\xD1\x82\xD0\xB5\xD1\x80\xD0\xB0"), wxT("ComputerName"));  // имякомпьютера
	helper.AliasMethod(wxString::FromUTF8("\xD0\xB8\xD0\xBC\xD1\x8F\xD0\xBF\xD0\xBE\xD0\xBB\xD1\x8C\xD0\xB7\xD0\xBE\xD0\xB2\xD0\xB0\xD1\x82\xD0\xB5\xD0\xBB\xD1\x8F"), wxT("UserName"));  // имяпользователя
