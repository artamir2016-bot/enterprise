...
bool ibValueMetaObjectCalculationRegister::PrepareContextMenu(wxMenu* defaultMenu)
{
...
void ibValueMetaObjectCalculationRegister::ProcessCommand(unsigned int id)
{
