...
ibValueReferenceDataObject* ibValueManagerDataObjectChartOfCalculationTypes::FindByCode(const ibValue& cParam) const
{
...
ibValueReferenceDataObject* ibValueManagerDataObjectChartOfCalculationTypes::FindByDescription(const ibValue& cParam) const
{
	if (appData->DesignerMode())
		return ibValueReferenceDataObject::Create(m_metaObject);
